...
export class Animation {
  ...
  update() {
    ...
    for (const transform of this.keyframes[this.timestamps[this.targetKeyframe]]) {
  ...
  linearInterpolation(transform, t) {
    ...
    const iAmmount = (t - keyframeStart) / (this.timestamps[this.targetKeyframe] - keyframeStart);
